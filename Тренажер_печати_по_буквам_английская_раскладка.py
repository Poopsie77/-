...
texts = {
    'qweklbv': {
        'en': [
            'qweklbvklbvweklbvkklbvkqweklbvweklbvkkklbvweklbvkklbvkqweklqweklbvweklbvkkkweklbvweklbvkkklbvweklbvkklbvkqwekl',
            'lbvkklbvkqwekeklbvweklbvkkklbvweklbvkklqweklbvweklbvkqweklbvklbvweklbvkklbvkqweklbvweklbvkkkweklbvweklbvkkklbl',
        ]
    },
    'zxprgqhj': {
        'en': [
            'hjgqhprgqhjzxprgqgqhprgqzxprgqhjgqhprgqhjzxprgqgqhprgqzxphjzxprgqhjgqhprgqhjzxpprqhprgqhjzxprgqgqhprgqzxgqhppr',
            'gqhprgqzxphjzxprgqhjgqhprgqhjzxpprgqhprgqhjzxpprqhprgqhjzxprgqgqhprgqzxgqhhjgqhprgqhjzxprgqgqhprgqzxgqhprgqzxg',
        ]
    },
    'dlquzkap': {
        'en': [
            'dlququzkuduzkapdlqulqupdlququzkapdluzkapdlququzkuzkapdlquappdlququzkupdlquqqupdlquququpdlququzkapdluzzkapdluzk',
            'dlququzkaplquzkdluzzquzkdluzzququzkapdluzququzkapdluzkapdluzkpdlququqdlququzkapdpdlququzkapdluzzlququzkaluzzlk',
        ]
    },
    'ghtdwnm': {
        'en': [
            'mghtdwnmdwghtdwnhtdwnmghtwnmmwnmmghtdwnmdwnmghtdmghtwnmmghtdwntdwnmdwnmdwnmmghtdwnmdwnmghtdmghtwnmmghtdwnmdwnm',
            'ghtdwnhtdwghtdwnhtdwnmdwghtdwnnmdwghtdwnhtdwnmghtwnghtdwnhtdwnmdwghtdwnmmwnmmghtghtdwnhtdwnmdwghtdwndmghtdwnht',
        ]
    },
    'qwlxcmd': {
        'en': [
            'cmdlxqwlxcmdcmdqwlxqwqwqwlxcmdlxqwlxcmdcmdqwqwlxcmdcmdqwlxqwwlxcmdcmdqwlxqwqwlxcmdcmdqwlxqwlxcmdcmdc',
            'lxcmdcmdqwqwlxcmdcmdqwlxqwwlxcmdcmdqwlxqwqwldlxqwlxcmdcmdqwlxmdqwqwlxcmdcmdqwlxqwwlxcmdcmdqwlxxcmdcl',
        ]
    }
}
...
class TypingTest_EN(tk.Tk):
    ...
    def __init__(self):
        ...
        self.en_label = tk.Label(self, bg="#E6F7FF")
        self.en_label.pack(padx=10, pady=70)
        ...
        self.en_label['image'] = photo
        self.en_label.image = photo
        self.en_label.pack(side=tk.BOTTOM, fill=tk.BOTH)
        ...
        self.level_var = tk.StringVar(value='qweklbv')
        level_options = ['qweklbv', 'zxprgqhj', 'dlquzkap','ghtdwnm','qwlxcmd']
